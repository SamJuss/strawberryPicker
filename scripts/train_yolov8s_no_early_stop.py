#!/usr/bin/env python3
"""
Train YOLOv8s on ripe-only dataset for 50 epochs without early stopping.
"""
...
def train_yolov8s_no_early_stop():
    ...
    name = f'ripe_only_yolov8s_no_early_stop_{datetime.now().strftime("%Y%m%d_%H%M%S")}'
    ...
    print(f"Training YOLOv8s on ripe-only dataset (no early stopping)")
